  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Twitter clone is developed by <span style="font-weight: 700;">Julia Francesca Reyes</span>  for assessment purposes.</p>
        <p>The clone project includes tweet, retweet, quote, like tweet and nested comments.
          You can tag or mention a user or add hashtag to your tweet, change password or username.
          Follow or unfollow other users. Get notified to stay updated!. 
        </p>
        <p>By default you followed
          <a style="color:#207ce5;" href="Uno">@user1</a> 
